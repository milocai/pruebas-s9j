...
| 3 | Cliquear el botón **Ingresar** | El sistema redirige a la ruta *http://localhost:3000/adm/generate-scheme* y muestra el contenido de la página correspondiente |
