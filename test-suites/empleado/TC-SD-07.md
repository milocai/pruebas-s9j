...
**Escenario:** como usuario con rol de **empleado**, validar que el sistema muestra cinco cuadros de solicitud de descanso al agregar cuatro fechas.

## Encabezado del caso de prueba:

| ID del caso de prueba | C. Uso/ Módulo | Objetivo de la prueba                                                                        | Versión del sistema | Fecha de creación |
| --------------------- | -------------- | -------------------------------------------------------------------------------------------- | ------------------- | ----------------- |
| **TC-SD-07**          | Solicitudes de Descanso | Verificar que el sistema muestra cinco cuadros de solicitud de descanso luego de oprimir cuatro veces el botón "Agregar fecha" | 1.0                 | 22/07/2023        |
